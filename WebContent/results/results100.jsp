...
<body>
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			<a class="navbar-brand" href="/SportfestOnePager/index.jsp"
				rel="external">Zurück zur Startseite</a>
		</div>
	...
	<div id="ergebnisse100M" class="pad-section">
		<div class="container">
			...
			<div data-role="main" class="ui-content">
				<form>
					<input id="filter-input-table2" data-type="search"
						placeholder="Ergebnisse suchen...">
				</form>
			</div>

			<table data-role="table" data-mode="columntoggle"
				class="ui-responsive ui-shadow" id="100M" data-filter="true"
				data-input="#filter-input-table2">
				<thead>
					<tr>
