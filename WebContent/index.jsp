...
<div id="wettkaempfe" class="pad-section">
  <div class="container">
    <h2 class="text-center">Die Wettkämpfe</h2> <hr />
    <div class="row text-center">
      <div class="col-sm-4 col-xs-6" id="div_werfen">
        <img class="img-responsive img-rounded" src="images/weitwurf.jpg" width="304" height="236">Zu den Ergebnissen</img>
        <h4>Werfen</h4>
      ...
      <div class="col-sm-4 col-xs-6" id="div_sprint">
        <img class="img-responsive img-rounded" src="images/50m.jpg" width="304" height="236">Zu den Ergebnissen</img>
        <h4>Sprint</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec in sem cras amet. Donec in sem cras amet.</p>
      </div>
      <div class="col-sm-4 col-xs-6" id="div_sprung">
        <img class="img-responsive img-rounded" src="images/weitsprung2.jpg" width="304" height="236">Zu den Ergebnissen</img>
        <h4>Weitsprung</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec in sem cras amet. Donec in sem cras amet.</p>
      </div>
    </div>
